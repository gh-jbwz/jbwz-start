package com.jbwz.lemon.server.message.sms.dao;
...
public class SendSMSDao {
   ...
   * 开始发送
   */
  public SendSmsResponse send(SMSRequest smsRequest) throws ClientException {
    ...
    request.setPhoneNumbers(smsRequest.getCommaPhones());
    //必填:短信签名-可在短信控制台中找到
    ...
    request.setTemplateParam(smsRequest.toString());
